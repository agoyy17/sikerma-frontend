...
const Adendum = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await axiosInstance.get('/addendum');
  ...
  const handleSubmit = (e) => {
    ...
    axiosInstance.post('/addendum', formDataToSend, {
      headers: {
            ...
            entries.map((entry) => (
              <tr key={entry.id}>
                ...
                <td>
                  ...
                  {/* Menampilkan nama file jika sudah diunggah */}
                  {entry.fileName && (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-footer">
                <button
                  ...
                  onClick={() => {
                    setIsModalOpen(false);
                    resetForm(); // Reset form saat tombol batal diklik
                  }}
                >
                  Batal
                </button>
